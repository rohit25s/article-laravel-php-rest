    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="header">
                    <h1 style="color:yellow;">E-Articles Sample Website</h1>
                </div>
                ...
                <div class="ml-12">
                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-m">
                        ...
                        This Website is a sample project for article submision from multiple authors. Each author can have multiple articles associated with his/her name.
                    </div>
                </div>
            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href = "http://people.tamu.edu/~rohit.sah">Rohit Sah</a></div>
                            </div>
                        </div>
                    </div>
                </div>
